...
function UserSection({ isCollapsed }: { isCollapsed: boolean }) {
        ...
        {showMenu && (
          <div className="absolute bottom-full left-full ml-2 mb-2 w-64 bg-white rounded-lg shadow-2xl border border-gray-200 overflow-hidden z-50">
            ...
            <Link
              ...
              className="w-full px-4 py-3 text-left text-sm text-slate-700 hover:bg-slate-50 transition-colors flex items-center gap-2 border-b border-gray-100"
            >
  ...
  return (
    <div className="p-4">
      ...
      <Link
        href="/profile"
        className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-slate-300 hover:text-white hover:bg-white/10 transition-colors mb-2"
      >
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
        </svg>
